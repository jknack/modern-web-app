...
* [Core Module] (tree/develop/mwa-core): applies sensible defaults to your application.
* [Mvc Module] (tree/develop/mwa-mvc): useful additions to Spring MVC.
* [Logging Module] (tree/develop/mwa-logging): classpath configuration of Java logging libraries.
* [JPA 2.0 Module] (tree/develop/mwa-jpa): configuration of Spring beans required by JPA 2.x.
* [Mongo Module] (tree/develop/mwa-mongo): configuration of Spring beans for MongoDB.
* [Morphia Module] (tree/develop/mwa-morphia): configuration of Spring beans for Morphia MongoDB.
* [Web Resource Optimizer Module] (tree/develop/mwa-wro4j): javascript and css compression, optimization and more.
* [Mail Module] (tree/develop/mwa-mail): a simple and powerful mail facade.
